...
<Info>
  Use the automatically issued `sk_test_` key to validate the create-order request and response only. Its file URLs are synthetic; use a live API key for the actual upload, AI Detection, and detection result.
</Info>
