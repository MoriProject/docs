...
<Info>
  Use the automatically issued [`sk_test_` key](/test-api-keys) to exercise the order lifecycle without running Anti-AI processing or consuming credits. Test uploads discard file contents and do not produce a downloadable result. Use a live API key when you need an actual protected image.
</Info>
