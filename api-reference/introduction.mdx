...
Use a test API key with the `sk_test_` prefix to validate your integration without running Anti-AI, watermark, or AI Detection processing. Test requests return synthetic responses and do not consume credits.
