...
<Info>
  Use the automatically issued `sk_test_` key to validate request and response handling only. Its file URLs are synthetic and it does not run processing or consume credits. Use a live API key for the actual upload and processing flow.
</Info>
