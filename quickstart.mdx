...
This guide walks you through creating an **Anti-AI protection order** — the most common integration pattern. A similar flow applies to Watermark Embed orders.
...
```php PHP
<?php
$ch = curl_init('https://api.bizmori.com/api/v2/orders/anti-ai/confirm');
curl_setopt_array($ch, [
    CURLOPT_POST           => true,
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_HTTPHEADER     => [
...
```ruby Ruby
req = Net::HTTP::Post.new(URI('https://api.bizmori.com/api/v2/orders/anti-ai/confirm'))
req['Authorization'] = 'Bearer YOUR_API_TOKEN'
req['Content-Type']  = 'application/json'
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.bizmori.com/api/v2/orders/anti-ai/confirm"))
    .header("Authorization", "Bearer YOUR_API_TOKEN")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString(body))
    .build();
...
```php PHP
<?php
$ch = curl_init('https://api.bizmori.com/api/v2/orders/123456789');
curl_setopt_array($ch, [
    CURLOPT_RETURNTRANSFER => true,
...
```ruby Ruby
req = Net::HTTP::Get.new(URI('https://api.bizmori.com/api/v2/orders/123456789'))
req['Authorization'] = 'Bearer YOUR_API_TOKEN'
data = JSON.parse(http.request(req).body)['data']
```
...
req, _ := http.NewRequest("GET",
	"https://api.bizmori.com/api/v2/orders/123456789", nil)
req.Header.Set("Authorization", "Bearer YOUR_API_TOKEN")
resp, _ := http.DefaultClient.Do(req)
defer resp.Body.Close()
```
...
```java Java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.bizmori.com/api/v2/orders/123456789"))
    .header("Authorization", "Bearer YOUR_API_TOKEN")
    .GET()
    .build();
var response = HttpClient.newHttpClient()
...
```php PHP
<?php
$ch = curl_init('https://api.bizmori.com/api/v2/orders/123456789/download');
curl_setopt_array($ch, [
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_HTTPHEADER     => ['Authorization: Bearer YOUR_API_TOKEN'],
]);
...
req = Net::HTTP::Get.new(
  URI('https://api.bizmori.com/api/v2/orders/123456789/download')
)
req['Authorization'] = 'Bearer YOUR_API_TOKEN'
data = JSON.parse(http.request(req).body)['data']
```
...
```go Go
req, _ := http.NewRequest("GET",
	"https://api.bizmori.com/api/v2/orders/123456789/download", nil)
req.Header.Set("Authorization", "Bearer YOUR_API_TOKEN")
resp, _ := http.DefaultClient.Do(req)
defer resp.Body.Close()
```
...
```java Java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.bizmori.com/api/v2/orders/123456789/download"))
    .header("Authorization", "Bearer YOUR_API_TOKEN")
    .GET()
    .build();
var response = HttpClient.newHttpClient()
